...
Calculated summaries: revenue, cancellations, top customers/items.

Exported results into a structured Excel workbook with multiple sheets.
...
Structuring code for reusability instead of one-off scripts.